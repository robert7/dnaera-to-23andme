...
The canonical list of 42 target SNPs is maintained in [README.md](README.md). Use that list as the source of truth during validation so the repo does not drift into conflicting copies.
