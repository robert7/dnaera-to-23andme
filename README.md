...
Standalone converter that turns DNAEra raw exports into 23andMe-style raw data files so tools with existing 23andMe import support can ingest them without code changes.
...
The converter writes a 23andMe-style text file:
